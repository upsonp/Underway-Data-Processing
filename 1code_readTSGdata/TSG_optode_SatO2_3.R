...
C <-exp(A0+(A1*Ts)+(A2*Ts^2)+(A3*Ts^3)+(A4*Ts^4)+(A5*Ts^5)+sal*(B0+B1*Ts+(B2*Ts^2)+(B3*Ts^3)) + C0*sal^2)
...
o2percentsat[y]=100*O2Concentration/o2sat_sw;
}
df <- data.frame(O2Concentration=O2Concentration, o2sat_sw =o2sat_sw,o2percentsat=o2percentsat)
df
